...
export default function FormationsPage() {
  ...
  const [type, setType] = useState<
    "ACADEMIE" | "BAPTEME" | "PORTEURS_DE_VIE" | "ECOLE_DES_BERGERS"
  >("ACADEMIE");
    ...
    async function loadFormations() {
      try {
        ...
        const res = await fetch(
          "/api/v1/formations?churchId=default-church-id",
        );
        ...
        if (json.success && json.data && json.data.length > 0) {
          ...
          setFormations([
            {
              id: "f1",
              name: "Académie des Disciples - Niveau 1",
              description: "Fondations de la vie chrétienne",
              type: "ACADEMIE",
            ...
            {
              id: "f2",
              name: "Classe de Baptême d'Impact",
              description: "Préparation doctrinale au baptême d'eau",
              type: "BAPTEME",
            ...
            {
              id: "f3",
              name: "Porteurs de Vie (Évangélisation)",
              description: "Formation pratique des gagneurs d'âmes",
              type: "PORTEURS_DE_VIE",
            ...
            {
              id: "f4",
              name: "École des Bergers (Niveau 1)",
              description: "Préparation des futurs responsables de GEM",
              type: "ECOLE_DES_BERGERS",
  ...
  const handleCreateFormation = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormations((prev) => [mockNew, ...prev]);
      showNotification(
        "Erreur de connexion. Formation ajoutée localement.",
        "success",
      );
      setIsModalOpen(false);
    } finally {
  ...
  const getTypeName = (t: string) => {
    switch (t) {
      case "ACADEMIE":
        return "Académie des Disciples";
      case "BAPTEME":
        return "Classe de Baptême";
      case "PORTEURS_DE_VIE":
        return "Porteurs de Vie";
      case "ECOLE_DES_BERGERS":
        return "École des Bergers";
      default:
        return t;
    }
  };
                ...
                <form onSubmit={handleCreateFormation} className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="BAPTEME">
                        Classe de Baptême (Nouveau-nés dans la foi)
                      </option>
                      <option value="PORTEURS_DE_VIE">
                        Porteurs de Vie (Évangélisation d&apos;impact)
                      </option>
                      <option value="ECOLE_DES_BERGERS">
                        École des Bergers (Formation des futurs leaders)
                      </option>
                    </select>
                  </div>
