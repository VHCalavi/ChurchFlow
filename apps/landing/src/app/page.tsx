...
export default function LandingPage() {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem("landing-theme") as
      | "LIGHT"
      | "DARK";
  ...
  const features = [
    {
      ...
      color: "#006C69",
      title: "Membres & Hiérarchie",
      desc: "Grades, Échelons, statuts et parcours pastoraux.",
    },
    {
      icon: <Network className="w-5 h-5" />,
      color: "#EC8001",
      title: "Groupes & GEMs",
      desc: "Tribus, Départements et cellules locales.",
    },
    {
      icon: <GraduationCap className="w-5 h-5" />,
      color: "#CEAD1E",
      title: "Formations & Écoles",
      desc: "PDV, École des Bergers, cursus de croissance.",
    },
    {
      icon: <CalendarDays className="w-5 h-5" />,
      color: "#8B5CF6",
      title: "Réunions & Agenda",
      desc: "Cultes, Agapés, présences et suivi d'assiduité.",
    },
    {
      icon: <Wallet className="w-5 h-5" />,
      color: "#10B981",
      title: "Comptabilité & Finances",
      desc: "Dîmes, offrandes, rapports et transparence FCFA.",
    },
    {
      icon: <Package className="w-5 h-5" />,
      color: "#B1C431",
      title: "Patrimoine & Logistique",
      desc: "Inventaire matériel, prestataires et achats.",
    },
    {
      icon: <Shield className="w-5 h-5" />,
      color: "#527EDB",
      title: "Permissions RBAC",
      desc: "Rôles configurables et contrôle d'accès granulaire.",
    },
    {
      icon: <Zap className="w-5 h-5" />,
      color: "#06A7B5",
      title: "Interface Premium",
      desc: "Design Metronic, mode clair & sombre inclus.",
    },
    {
      icon: <Globe className="w-5 h-5" />,
      color: "#006C69",
      title: "Multi-Tenant",
      desc: "Chaque église dispose de son espace isolé et sécurisé.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-[-20%] left-[-10%] w-[700px] h-[700px] rounded-full blur-[180px] pointer-events-none transition-opacity ${
          isDark ? "bg-[#06a7b5] opacity-[0.07]" : "bg-[#06a7b5] opacity-[0.04]"
        }`}
      />
      <div
        className={`absolute top-[60%] right-[-8%] w-[500px] h-[500px] rounded-full blur-[160px] pointer-events-none transition-opacity ${
          isDark
            ? "bg-[#ec8001] opacity-[0.04]"
            : "bg-[#ec8001] opacity-[0.025]"
        }`}
      />
      ...
      <header
        className={`sticky top-0 z-50 w-full border-b transition-all duration-300 ${
          isDark
            ? "border-white/5 bg-[#090a0f]/90 backdrop-blur-xl"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center space-x-3 group shrink-0">
            ...
            <span
              className={`font-black text-xl tracking-tight transition-opacity group-hover:opacity-80 ${isDark ? "text-white" : "text-slate-900"}`}
            >
      ...
      {mobileMenuOpen && (
        <div
          className={`fixed inset-x-0 top-20 z-40 md:hidden border-b p-6 shadow-2xl ${
      ...
      <section
        id="hero"
        className="max-w-7xl mx-auto px-6 pt-20 pb-28 md:pt-28 md:pb-36 text-center relative z-10"
      >
        {/* Live badge */}
        <div
          className={`inline-flex items-center space-x-2.5 px-4 py-2 rounded-full border mb-8 ${
            isDark
              ? "border-[#06a7b5]/20 bg-[#06a7b5]/5"
              : "border-[#06a7b5]/25 bg-[#06a7b5]/8"
          }`}
        >
          <span className="flex w-2 h-2 rounded-full bg-[#06a7b5] animate-pulse" />
          <span className="text-xs font-bold uppercase tracking-wider text-[#06a7b5]">
        ...
        {/* Headline */}
        <h1
          className={`max-w-5xl mx-auto text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.05] mb-6 ${
        ...
        {/* Subtitle */}
        <p
          className={`max-w-2xl mx-auto text-base sm:text-lg md:text-xl font-medium leading-relaxed mb-10 ${
            isDark ? "text-slate-400" : "text-slate-600"
          }`}
        >
          La plateforme SaaS tout-en-un pour gérer vos membres, tribus, GEMs,
          formations, réunions et finances — avec un design premium Metronic.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          ...
          >
            <Play
              className={`w-4 h-4 ${isDark ? "fill-slate-300 text-transparent" : "fill-slate-700 text-transparent"}`}
            />
        ...
        {/* Dashboard mockup */}
        <div
          className={`relative max-w-6xl mx-auto rounded-2xl border p-3 transition-all ${
            isDark
        ...
        >
          ...
          {/* Window bar */}
          <div
            className={`flex items-center space-x-2 px-3 pb-3 border-b ${isDark ? "border-white/5" : "border-slate-200"}`}
          >
            <span className="w-3 h-3 rounded-full bg-red-500/80" />
            <span className="w-3 h-3 rounded-full bg-yellow-500/80" />
            <span className="w-3 h-3 rounded-full bg-green-500/80" />
            <span className="text-xs text-slate-500 font-semibold tracking-wider ml-4 uppercase">
              ChurchFlow Admin — Portail VH Calavi
            </span>
          </div>
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={`flex items-center space-x-2.5 px-3 py-2 rounded-lg transition-colors ${
                        item.active
                          ? "bg-[#06a7b5]/10 border border-[#06a7b5]/20 text-[#06a7b5]"
                          : "hover:bg-white/5 hover:text-white"
                      }`}
                    >
                      <span
                        style={{ color: item.active ? "#06a7b5" : item.color }}
                      >
                        {item.icon}
                      </span>
                      <span
                        className={item.active ? "font-bold" : "font-medium"}
                      >
                        {item.label}
                      </span>
                    </div>
            ...
            <div className="flex-1 flex flex-col bg-[#090a0f] overflow-hidden">
              <header className="h-12 border-b border-white/5 px-4 flex items-center justify-between shrink-0 bg-[#0d0e15]/50">
                <span className="font-bold text-white text-xs">
                  Portail VH Calavi — Tableau de Bord Global
                </span>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {[
                    ...
                    },
                    {
                      label: "GEM ACTIFS",
                      value: "42",
                      sub: "6 Équipes Tribales",
                      subColor: "text-[#ec8001]",
                    },
                    {
                      label: "EN FORMATION",
                      value: "88",
                      sub: "École des bergers",
                      subColor: "text-[#cead1e]",
                    },
                    {
                      label: "DÎMES & OFFRANDES",
                      value: "+24%",
                      sub: "Trésorerie saine",
                    ...
                    <div
                      key={i}
                      className="bg-[#121420] border border-white/5 rounded-xl p-3"
                    >
                      <span className="text-[9px] text-slate-500 font-bold block mb-1">
                        {stat.label}
                      </span>
                      <span
                        className={`text-sm font-extrabold ${stat.valueColor || "text-white"}`}
                      >
                        {stat.value}
                      </span>
                      <span
                        className={`text-[8px] font-bold flex items-center mt-1 ${stat.subColor}`}
                      >
                        {stat.icon}
                        {stat.sub}
                      </span>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-2 bg-[#121420] border border-white/5 rounded-xl p-3 flex flex-col">
                    <div>
                      <span className="text-xs font-bold text-white block mb-0.5">
                        Croissance mensuelle de l'Audience
                      </span>
                      <span className="text-[8px] text-slate-500 font-semibold">
                        Inscriptions directes aux cultes
                      </span>
                    </div>
                    <div className="h-28 w-full relative mt-3">
                      ...
                      >
                        ...
                        <path
                          d="M 0 90 Q 50 60 100 75 T 200 40 T 300 10 L 300 100 L 0 100 Z"
                          fill="url(#g1)"
                        />
                        <path
                          d="M 0 90 Q 50 60 100 75 T 200 40 T 300 10"
                          fill="none"
                          stroke="#06a7b5"
                          strokeWidth="2.5"
                        />
                  ...
                  <div className="bg-[#121420] border border-white/5 rounded-xl p-3 flex flex-col">
                    <span className="text-xs font-bold text-white block mb-2">
                      Activités Récentes GEM
                    </span>
                    <div className="space-y-2 flex-1">
                      {[
                        {
                          dot: "#06a7b5",
                          label: "GEM VH Calavi Centre",
                          sub: "12 Présences enregistrées",
                        },
                        {
                          dot: "#ec8001",
                          label: "GEM PDV Ouidah",
                          sub: "Nouveau baptisé enregistré",
                        },
                        {
                          dot: "#cead1e",
                          label: "Académie de croissance",
                          sub: "Session pastorale clôturée",
                        },
                      ].map((item, i) => (
                        <div
                          key={i}
                          className="flex items-center space-x-2 py-1 border-b border-white/5 last:border-0"
                        >
                          <div
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-semibold text-slate-350 truncate">
                              {item.label}
                            </p>
      ...
      {/* ===== METRICS BAR ===== */}
      <section
        className={`border-t border-b py-14 relative z-10 transition-colors ${
          isDark
            ? "border-white/5 bg-[#0d0e15]/60"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            {
              value: "50 000+",
              label: "Membres Actifs Gérés",
              color: "text-[#06a7b5]",
            },
            {
              value: "180+",
              label: "Églises & GEM Déployés",
              color: "text-[#ec8001]",
            },
            {
              value: "0 FCFA",
              label: "Pour Toujours Gratuit",
              color: "text-[#10B981]",
            },
          ].map((stat, i) => (
            <div key={i}>
              <p
                className={`text-3xl md:text-4xl font-extrabold mb-2 ${stat.color}`}
              >
                {stat.value}
              </p>
              <p
                className={`text-xs md:text-sm font-bold uppercase tracking-wider ${isDark ? "text-slate-400" : "text-slate-500"}`}
              >
                {stat.label}
              </p>
            </div>
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-black uppercase tracking-widest text-[#06a7b5] block mb-3">
            MODULES MÉTIERS
          </span>
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl font-black leading-tight mb-4 ${isDark ? "text-white" : "text-slate-900"}`}
          >
            Tout ce dont votre Église a Besoin
          </h2>
          <p
            className={`text-base font-medium leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
          >
            De la hiérarchie pastorale à la comptabilité, chaque aspect de votre
            communauté est structuré de manière optimale.
          </p>
        </div>
          ...
          {modules.map((mod) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs font-bold tracking-tight block truncate w-full">
                  {mod.title}
                </span>
              </button>
            );
          ...
          return (
            <div
              ...
              className={`rounded-2xl border p-6 md:p-10 grid md:grid-cols-2 gap-8 items-center shadow-lg ${
                isDark
                  ? "bg-[#0d0e15] border-white/8 text-slate-100"
            ...
            >
              <div>
                ...
                <p
                  className={`text-base font-medium leading-relaxed mb-6 ${isDark ? "text-slate-400" : "text-slate-600"}`}
                >
                  {mod.desc}
                </p>
                <ul className="space-y-3.5">
                  {mod.bullets.map((bullet, idx) => (
                    <li
                      key={idx}
                      className={`flex items-start space-x-3 text-sm font-semibold ${isDark ? "text-slate-300" : "text-slate-700"}`}
                    >
              ...
              <div
                className={`border rounded-2xl p-6 relative overflow-hidden h-[300px] flex items-center justify-center ${
                  isDark
              ...
              >
                ...
                {mod.id === "membres" && (
                  <div className="relative w-full max-w-sm space-y-3.5 z-10 text-xs font-semibold">
                    <div className="p-3 bg-[#121420] border border-white/5 rounded-xl flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-full bg-[#006c69]/20 border border-[#006c69]/30 flex items-center justify-center text-[#006c69] font-bold">
                          PO
                        </div>
                        <div>
                          ...
                          <p className="text-[9px] text-[#006c69] uppercase font-extrabold">
                            Statut: Responsable
                          </p>
                        </div>
                      </div>
                      <span className="px-2 py-1 rounded bg-[#06a7b5]/10 text-[#06a7b5] text-[9px] font-black uppercase">
                        PASTEUR TITULAIRE
                      </span>
                    </div>
                ...
                {mod.id === "groupes" && (
                  <div className="relative w-full max-w-xs z-10 text-xs font-semibold">
                    <div className="p-3 bg-[#121420] border border-white/5 rounded-xl text-center mb-3">
                      <p className="text-[9px] text-[#ec8001] font-extrabold uppercase mb-1">
                        Structure Régionale
                      </p>
                      <p className="text-white font-bold">
                        Tribu du Sud (VH Calavi)
                      </p>
                    </div>
                    <div className="grid grid-cols-2 gap-2.5 pl-6 relative">
                      <div className="absolute left-2.5 top-0 bottom-6 w-0.5 bg-white/5" />
                      {["GEM Calavi 1 — 12p", "GEM Ouidah 2 — 8p"].map(
                        (g, i) => (
                          <div
                            key={i}
                            className="p-2 bg-[#121420] border border-white/5 rounded-lg flex items-center justify-between"
                          >
                            <span className="text-white font-bold truncate text-xs">
                              {g.split(" —")[0]}
                            </span>
                            <span className="px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[8px] font-black">
                              {g.split("— ")[1]}
                            </span>
                          </div>
                        ),
                  ...
                  <div className="relative w-full max-w-xs space-y-3 z-10 text-xs font-semibold">
                    <div className="p-3 bg-[#121420] border border-white/5 rounded-xl">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-[#cead1e] font-bold text-[9px]">
                          Promo 4 — En cours
                        </span>
                      </div>
                    ...
                    <div className="p-3 bg-[#121420] border border-white/5 rounded-xl flex justify-between items-center">
                      ...
                      <span className="px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[8px] font-black">
                        Session Active
                      </span>
                    </div>
                  </div>
                ...
                {mod.id === "reunions" && (
                  <div className="relative w-full max-w-xs space-y-2 z-10 text-xs font-semibold">
                    {[
                      {
                        dot: "#8B5CF6",
                        title: "Culte d'Adoration Principal",
                        sub: "Chaque Dimanche à 08:30",
                        tag: "Culte",
                      },
                      {
                        dot: "#ec8001",
                        title: "Agapé Fraternel de Tribu",
                        sub: "Mardi Prochain à 19:00",
                        tag: "Rencontre",
                      },
                    ].map((r, i) => (
                      <div
                        key={i}
                        className="p-2.5 bg-[#121420] border border-white/5 rounded-xl flex items-center justify-between"
                      >
                        ...
                        <span className="px-2 py-0.5 rounded bg-white/5 text-white text-[8px] font-bold">
                          {r.tag}
                        </span>
                      </div>
                    ))}
                ...
                {mod.id === "administration" && (
                  <div className="relative w-full max-w-xs space-y-2.5 z-10 text-xs font-semibold">
                    {[
                      {
                        title: "Console Audio Behringer X32",
                        sub: "Électronique & Son",
                        badge: "Actif",
                        badgeColor: "bg-emerald-500/10 text-emerald-400",
                      },
                      {
                        title: "Projecteur Epson 4K Pro",
                        sub: "Vidéo & Médias",
                        badge: "Maintenance",
                      ...
                      <div
                        key={i}
                        className="p-2.5 bg-[#121420] border border-white/5 rounded-xl flex justify-between items-center"
                      >
                        <div>
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-[8px] font-black ${item.badgeColor}`}
                        >
                          {item.badge}
                        </span>
                      </div>
      ...
      <section
        id="hierarchie"
        className={`border-t py-24 md:py-32 relative z-10 transition-colors ${
          isDark
            ? "border-white/5 bg-[#0d0e15]/50"
            : "border-slate-200 bg-slate-50"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-black uppercase tracking-widest text-[#ec8001] block mb-3">
            ...
            <p
              className={`text-base font-medium leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
            >
              Modélisez fidèlement le parcours d'engagement de vos leaders et
              l'étendue de leurs responsabilités pastorales.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Grades */}
            <div
              className={`rounded-2xl border p-6 md:p-8 ${isDark ? "bg-[#0d0e15] border-white/8" : "bg-white border-slate-200 shadow-sm"}`}
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                >
                  Les Grades Pastoraux
                </h3>
              </div>
              <p
                className={`text-sm font-medium leading-relaxed mb-6 ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Définit le niveau d'autorité, de maturité spirituelle et le
                cursus pastoral validé au sein du ministère.
              </p>
              <div className="space-y-2.5">
                {[
                  {
                    name: "Pasteur Titulaire",
                    level: "Niveau 6",
                    active: true,
                  },
                  ...
                  >
                    <span
                      className={`font-bold text-xs ${grade.active ? "text-[#06a7b5]" : isDark ? "text-slate-300" : "text-slate-700"}`}
                    >
                      {grade.name}
                    </span>
                    <span
                      className={`text-xs font-extrabold uppercase tracking-widest px-2 py-0.5 rounded ${
                        grade.active
                          ? "bg-[#06a7b5] text-white"
                          : isDark
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3
                  className={`text-xl font-bold ${isDark ? "text-white" : "text-slate-900"}`}
                >
                  Les Échelons d'Impact
                </h3>
              </div>
              <p
                className={`text-sm font-medium leading-relaxed mb-6 ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Mesure l'étendue des responsabilités pratiques et le nombre de
                fidèles encadrés activement.
              </p>
              <div className="space-y-2.5">
                {[
                  {
                    name: "GA C100",
                    scope: "100 personnes et plus",
                    active: true,
                  },
                  ...
                  >
                    <span
                      className={`font-bold text-xs ${echelon.active ? "text-[#ec8001]" : isDark ? "text-slate-300" : "text-slate-700"}`}
                    >
                      {echelon.name}
                    </span>
                    <span
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p
            className={`text-base font-medium leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
          >
            ChurchFlow est développé pour les communautés chrétiennes d'Afrique.
            Pas de plan, pas de niveaux, pas de coûts cachés. Un accès complet à
            tout, pour toujours.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-14">
          {features.map((feat, idx) => (
            ...
            >
              ...
              <p
                className={`text-xs font-medium leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                {feat.desc}
              </p>
            </div>
        ...
        {/* Free CTA block */}
        <div
          className={`rounded-3xl border-2 p-10 md:p-14 relative overflow-hidden text-center ${
            isDark
          ...
          <div className="relative z-10">
            <div
              className={`inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-6 mx-auto ${
                isDark
                  ? "bg-[#06a7b5]/10 border border-[#06a7b5]/20"
                  : "bg-[#06a7b5]/10"
              }`}
            >
              <span
              ...
              <span className="text-lg font-black text-[#06a7b5] mt-2">
                FCFA
              </span>
            </div>
            <h3
            ...
            <p
              className={`max-w-xl mx-auto text-base font-semibold mb-8 ${isDark ? "text-slate-400" : "text-slate-600"}`}
            >
              Aucune carte bancaire. Aucun engagement. Aucune limite cachée.
              Rejoignez les centaines d'églises qui font confiance à ChurchFlow.
            </p>
            <a
              href="https://churchflow-indol.vercel.app/login"
            ...
            <p
              className={`text-xs font-semibold mt-5 ${isDark ? "text-slate-500" : "text-slate-500"}`}
            >
              Connexion instantanée · Aucune installation requise · Données
      ...
      >
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p
              className={`text-base font-medium ${isDark ? "text-slate-400" : "text-slate-600"}`}
            >
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border overflow-hidden transition-all ${
                    isDark
                      ? isExpanded
                        ? "bg-[#0d0e15] border-[#06a7b5]/20"
                        : "bg-[#0d0e15] border-white/5"
                      : isExpanded
                        ? "bg-white border-[#06a7b5]/30 shadow-sm"
                ...
                >
                  <button
                    ...
                    className={`w-full px-6 py-5 text-left flex items-center justify-between font-bold text-sm transition-colors ${
                      isDark
                        ? "text-white hover:text-[#06a7b5]"
                        : "text-slate-900 hover:text-[#06a7b5]"
                    }`}
                  >
                    <span className="pr-4">{faq.q}</span>
                    <ChevronDown
                      className={`w-5 h-5 shrink-0 transition-transform duration-300 ${isExpanded ? "rotate-180 text-[#06a7b5]" : "text-slate-400"}`}
                    />
                  </button>
                  {isExpanded && (
                    <div
                      className={`px-6 pb-5 border-t text-sm font-medium leading-relaxed ${
                        isDark
      ...
      {/* ===== FINAL CTA ===== */}
      <section
        className={`relative py-24 md:py-32 z-10 border-t overflow-hidden ${isDark ? "border-white/5 bg-[#090a0f]" : "border-slate-200 bg-white"}`}
      >
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <span className="text-xs font-black uppercase tracking-widest text-[#06a7b5] block mb-4">
            REJOIGNEZ LA COMMUNAUTÉ
          </span>
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl font-black leading-tight mb-6 ${isDark ? "text-white" : "text-slate-900"}`}
          >
            Prêt à Transformer la Gestion de votre Église ?
          </h2>
          <p
            className={`max-w-2xl mx-auto text-base font-semibold leading-relaxed mb-10 ${isDark ? "text-slate-400" : "text-slate-600"}`}
          >
            Rejoignez dès aujourd'hui les pasteurs et bergers de GEM qui font
            confiance à ChurchFlow pour piloter leur communauté — gratuitement,
            sans aucune limite.
          </p>
      ...
      {/* ===== FOOTER ===== */}
      <footer
        className={`border-t py-12 relative z-10 ${isDark ? "border-white/5 bg-[#07080d]" : "border-slate-200 bg-slate-50"}`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span
                  className={`font-black text-base tracking-tight ${isDark ? "text-white" : "text-slate-900"}`}
                >
                  ChurchFlow<span className="text-[#06a7b5]">.SaaS</span>
                </span>
                <p
            ...
            <div className="flex flex-wrap justify-center gap-6 text-xs font-semibold">
              {[
                ...
                <a
                  key={link.href}
                  href={link.href}
                  className={`transition-colors ${isDark ? "text-slate-500 hover:text-white" : "text-slate-500 hover:text-slate-900"}`}
                >
                  {link.label}
                </a>
              ))}
          ...
          <div
            className={`border-t pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-semibold ${isDark ? "border-white/5 text-slate-600" : "border-slate-200 text-slate-400"}`}
          >
            <span>
              © {new Date().getFullYear()} ChurchFlow. Tous droits réservés.
            </span>
