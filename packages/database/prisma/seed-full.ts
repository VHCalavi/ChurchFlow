...
async function main() {
  ...
  const groupsData = [
    ...
    { name: "GEM Victoire", type: GroupType.CELLULE, description: "GEM Quartier Arconville" },
    { name: "GEM Paix", type: GroupType.CELLULE, description: "GEM Quartier Zogbadjè" },
    { name: "GEM Amour", type: GroupType.CELLULE, description: "GEM Quartier Tankpè" },
    { name: "GEM Joie", type: GroupType.CELLULE, description: "GEM Quartier Bidossessi" },
